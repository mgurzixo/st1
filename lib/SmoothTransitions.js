...
export async function stGoto(action, theOptions) {
    ...
    if (1) {
        ...
        console.log(`[doIlink] resAction:${typeof resAction}`);
        console.log(`[doIlink] resAction=${JSON.stringify(resAction)}`);
        ...
        console.log(`[doIlink] resPromise=${resPromise}`);
        // console.log(`[doIlink] starting transition`);
